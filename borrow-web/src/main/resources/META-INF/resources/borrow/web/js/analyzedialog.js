define([ "eui/modules/edialog","eui/modules/eform","eui/modules/ecombobox"],
    function (edialog,eform,ecombobox) {
        ...
        AnalyzeDialog.prototype._initUI = function (){
            ...
            strhtml.push('           placeholder="'+I18N.getString("borrow.web.js.analyzedialog.js.plaanalyzename", "请填写分析表名称不能是纯数字！")+'">');
            ...
            strhtml.push('      </div>');
            strhtml.push('      <div class="eui-form-item">');
            strhtml.push('          <label class="eui-form-label eui-form-required"> '+I18N.getString("borrow.web.js.analyzedialog.js.analyzetype", "统计图类型")+'：</label>');
        ...
        AnalyzeDialog.prototype._initGraphList = function (){
            ...
            this.graphComboboxObj  =new EListCombobox({
                ...
                height:"100%",
                datas:[
                    {caption: I18N.getString("borrow.web.js.analyzedialog.js.barchart", "条形图"), value: "barchart"},
                    {caption: I18N.getString("borrow.web.js.analyzedialog.js.histogram", "柱状图"), value: "histogram"},
                    ],
                showFilter:false,
                showCheckAll:false,
                placeholder:I18N.getString("borrow.web.js.analyzedialog.js.chooseanalyzetype", "请选择统计图类型！"),
            ...
            this.addButton(I18N.getString("ES.COMMON.CONFIRM", "确定"),"",false,true,function (){
                if(EUI.isFunction(self.onok)){
                    ...
                    if (self.check()){//数据正确
                        ...
                        if (!flag){
                            EUI.showMessage(I18N.getString("borrow.web.js.analyzedialog.js.exitanalyze", "已存在表名为《{0}》的分析表",[self.data.name])
        ...
        AnalyzeDialog.prototype.check = function (){
            ...
            if (isNull(self.data.name)){
                self.showErrMsg("nametips",I18N.getString("borrow.web.js.analyzedialog.js.noanalyzename", "分析表名称不能为空"));
                flag = false;
            }else {
                if (isNum(self.data.name)){
                    self.showErrMsg("nametips",I18N.getString("borrow.web.js.analyzedialog.js.allnumber", "分析表名称不能全为数字"));
                    flag = false;
                }else{
            ...
            if (self.data.id==null){
                self.showErrMsg("graphcomboboxtips",I18N.getString("borrow.web.js.analyzedialog.js.notype", "统计图类型不能为空"));
                flag=  false;
            } else{
