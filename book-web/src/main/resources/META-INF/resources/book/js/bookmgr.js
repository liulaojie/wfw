define(["eui/modules/uibase", "eui/modules/ecoolbar", "eui/modules/elist", "eui/modules/epagebar"],
    function (uibase, ecoolbar,elist,epagebar) {
         ...
         */
        var customSort = [
            {id:"first",text:I18N.getString("book.js.first", "首页"),cssText:";color:#87CEEB;font-weight: bold;"},
            {id:"previous",text:I18N.getString("book.js.Previous", "上一页"),cssText:";color:#87CEEB;font-weight: bold;"},
            {id:"main",text:I18N.getString("book.js.main", "第,页  共{0}页"),cssText:";color:#000000;font-weight: bold;"},
            {id:"next",text:I18N.getString("book.js.next", "下一页"),cssText:";color:#87CEEB;font-weight: bold;"},
            {id:"last",text:I18N.getString("book.js.last", "下一页"),cssText:";color:#87CEEB;font-weight: bold;"},
            {id:"total",text:I18N.getString("book.js.total", "每页三十条共{1}条"),cssText:";color:#000000;font-weight: bold;"}
        ]
        /**
         * BookMgr的构造函数
         */
        ...
        BookMgr.prototype._initCoolBar = function (){
            ...
            var dom= band.addButton(null,I18N.getString("book.js.addbook", "新建图书"));
            dom.setName("newBook");
        ...
        BookMgr.prototype._initList = function (){
            ...
            this.listObj = new EList({
                ...
                columns:[{
                    ...
                    caption:I18N.getString("book.js.bcaption", "大类"),
                    id:"bcaption",
                    sort:false,

                },{
                    caption:I18N.getString("book.js.scaption", "小类"),
                    id:"scaption",
                    indexConlum:true,
                    start:10,//序号列的起始值
                    hint:true,      //该列是否开启提示
                    ...
                    caption:I18N.getString("book.js.name", "书名"),
                    id:"name",
                    hint:true,      //该列是否开启提示
                },{
                    caption:I18N.getString("book.js.desc", "描述"),
                    id:"desc",
                    width: 500,
                    hint:true,      //该列是否开启提示
                },{
        ...
        BookMgr.prototype._showDialog = function (isnew,datas){
            ...
            if(!self.bookdialog) {
                ...
                if (isnew){
                    self.bookdialog.setCaption(I18N.getString("book.js.addbook", "新建图书"))
                }else {
                    self.bookdialog.setCaption(I18N.getString("book.js.editbook", "编辑图书"))
                }
            }
            //打开对话框
        ...
        BookMgr.prototype._initData = function (bcaption,pageIndex){
            ...
            //初始化列表中数据
            EUI.post({
                url:EUI.getContextPath()+"service/book/bookList.do",
                data:{
                    bcaption:bcaption,
                    pageIndex:pageIndex
                },
